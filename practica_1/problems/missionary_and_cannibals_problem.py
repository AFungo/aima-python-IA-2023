...
from practica_1.problems.abstractproblem import State, Actions
...
class CannibalAndMissionaryState(State):
    ...
    def initial_state(self):
        return CannibalAndMissionaryState((3, 3), (0, 0), Side.BEGIN)

    def is_goal(self):
        return self.begin == (0, 0) and self.end == (3, 3)
...
def departure_is_enable(state, missionaries, cannibals):
    ...
    return current_missionaries >= 0 and current_cannibals >= 0 and (current_missionaries - current_cannibals >= 0 or current_missionaries == 0)
